...
#    --dataset-name field1031_v2 \
#    --config "${SEGY_CONFIG}" \
#    --mode fixed

python "${PY_SCRIPT}" \
    --irr /data/shared/dongfang_syn_reg/004-sw06-Sj5-irr30.sgy\
    --label /data/shared/dongfang_syn_reg/004-sw06-Sj5-label.sgy\
    --mask /data/shared/dongfang_syn_reg/mask_miss30pct_004-sw06-Sj5-label.sgy\
    --dataset-name sw06_v2 \
    --config "${SEGY_CONFIG}" \
    --mode fixed